...
const SOURCE_DATASET = "analytics_208192685"; /* the database containing the GA4 BigQuery exports */
const REPORTING_TIME_ZONE = "Europe/Helsinki"; /* replace with your property reporting time zone, this will update the timestamp columns from UTC to your GA4 property timezone (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) */
...
const GADS_SOURCE_PROJECT = "oikio-markkinointi"; /* your Google Ads data transfer project. you would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
const GADS_SOURCE_DATASET = "google_ads_2024"; /* your Google Ads data transfer source dataset */
const GADS_CUSTOMER_ID = "6787986346"; /* your Google Ads customer id, excluding the dashes (-), example "1234567890" */
